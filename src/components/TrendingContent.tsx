    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-8">
            ...
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>Viral short-form content</CardDescription>
                </div>
                <Button 
                  variant="outline" 
              ...
              <ScrollArea className="w-full whitespace-nowrap">
                <div className="flex space-x-4 pb-4">
                  {youtubeShorts.map((short) => (
                    <div key={short.id} className="group cursor-pointer flex-shrink-0 w-64">
                      ...
                      <h4 className="font-medium mt-2 line-clamp-2 group-hover:text-purple-500 transition-colors">{short.title}</h4>
                      <p className="text-sm text-muted-foreground">{short.creator}</p>
                    </div>
                  ))}
                </div>
          ...
          <Card className="glass-card">
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>Must-read articles and insights</CardDescription>
                </div>
                <Button 
                  variant="outline" 
            ...
            <CardContent>
              <ScrollArea className="w-full whitespace-nowrap">
                <div className="flex space-x-4 pb-4">
                  {blogs.map((blog) => (
                    <div key={blog.id} className="group cursor-pointer flex-shrink-0 w-64">
                      <div className="relative overflow-hidden rounded-lg">
                        <img 
                          src={blog.image} 
                          alt={blog.title} 
                      ...
                      <h4 className="font-medium mt-2 line-clamp-2 group-hover:text-purple-500 transition-colors">{blog.title}</h4>
          ...
          {/* Highlighted Podcast Clips Card */}
          <Card className="glass-card">
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  <CardTitle className="text-xl flex items-center">
                    ...
                    Highlighted Podcast Clips
                  </CardTitle>
                  <CardDescription>Featured audio content</CardDescription>
                </div>
                <Button 
                  variant="outline" 
              ...
              <ScrollArea className="w-full whitespace-nowrap">
                <div className="flex space-x-4 pb-4">
                  {podcasts.map((podcast) => (
                    <div key={podcast.id} className="group cursor-pointer flex-shrink-0 w-64">
                      <div className="relative overflow-hidden rounded-lg">
                        <img 
                          src={podcast.image} 
                          alt={podcast.title} 
                      ...
                      <h4 className="font-medium mt-2 line-clamp-2 group-hover:text-purple-500 transition-colors">{podcast.title}</h4>
